...
class TrajectoryClientNode(Node):
    ...
    def send_request(self, x_pts, y_pts, z_pts, quat):
...
def main(args=None):
    ...
    future = client_node.send_request(
        x_pts.tolist(), y_pts.tolist(), z_pts.tolist(), q_B_G
    )
